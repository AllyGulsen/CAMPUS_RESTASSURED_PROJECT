...
public class Attestation {
    ...
    public void getAttestation(){
      ...
      getBody.put("id",attestation_id);
        ...
        given()
                ...
                .when()
                .post("/school-service/api/attestation/search")
                .then()
                .log().body()
                .statusCode(200);
    ...
    @Test(priority = 8)
    public void getNegativeAttestation(){
        given()
                .spec(reqSpec)
                .cookies(cookies)
                .when()
                .get("/school-service/api/attestation/"+attestation_id)
                .then()
                .log().body()
                .statusCode(400);
    ...
    @Test(priority = 9)
    public void deleteNegativeAttestation(){
        given()
                .spec(reqSpec)
                .cookies(cookies)
                .when()
